        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-0 top-0 h-full w-64 bg-slate-900/95 backdrop-blur-sm z-50 p-6 shadow-xl border-l border-slate-800/50"
            >
                    ...
                    {menuItems.map((item) => (
                      <li key={item.name}>
                        <a
                          href={item.href}
                          onClick={() => setIsOpen(false)}
                          className="block text-lg text-white hover:text-indigo-400 transition-colors py-2"
                        >
                          {item.name}
                        </a>
                      </li>
